            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url() ?>gizipr/edit/<?= $key['id_gizipr']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
                                                <button class="btn btn-simple btn-warning btn-icon" data-toggle="modal" data-target="#hapusstatus<?= $key['id_gizipr']; ?>"><i class="material-icons">close</i></button>
                                            </td>
                                        </tr>
                                        <?php $no++; ?>
                                    <?php endforeach; ?>
                        ...
                        <?php foreach ($data as $key) : ?>
                            <div class="modal fade" id="hapusstatus<?= $key['id_gizipr']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-small ">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?= base_url(); ?>gizipr/hapus/<?= $key['id_gizipr']; ?>">
                                            <div class="modal-body text-center">
                                                <h5>Apakah Anda yakin ingin menghapus data status ini? </h5>
                                            </div>
