                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url() ?>gizilk/edit/<?= $key['id_gizilk']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
                            ...
                            <div class="modal fade" id="hapusstatus<?= $key['id_gizilk']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-small ">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?= base_url(); ?>gizilk/hapus/<?= $key['id_gizilk']; ?>">
